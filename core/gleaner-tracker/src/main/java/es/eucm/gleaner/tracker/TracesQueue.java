...
import es.eucm.gleaner.tracker.conversor.TracesConversor;
...
public class TracesQueue implements RequestCallback {
     ...
     */
    private TracesConversor conversor;
    ...
    public TracesQueue(RequestHelper requestHelper,
        ...
        this.conversor = new TracesConversor();
    ...
    public void flush() {
        if (storedTraces.size() > 0
            ...
            requestHelper.url(url)
                    .header(Header.AUTHORIZATION2, trackData.getAuthToken())
                    .post(conversor.convert(tracesToSend,trackData.getPlayerName()), this);
        }
    }
